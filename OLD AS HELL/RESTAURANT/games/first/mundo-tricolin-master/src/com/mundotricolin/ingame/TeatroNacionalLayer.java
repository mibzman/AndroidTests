...
public class TeatroNacionalLayer extends CCLayer {
	
	CCSprite fondo;
	CCSprite regresar;
	TeatroNacional escena;
	CGSize winSize = CCDirector.sharedDirector().displaySize();
	
	public TeatroNacionalLayer(TeatroNacional escena) 
	{
		super();
		...
		// Crear fondo
		fondo = CCSprite.sprite("fondoTeatro.jpg");
