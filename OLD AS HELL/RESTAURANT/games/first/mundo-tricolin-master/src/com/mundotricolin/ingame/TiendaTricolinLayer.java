...
public class TiendaTricolinLayer extends CCLayer {
	
	CCSprite fondo;
	CCSprite regresar;
	TiendaTricolin escena;
	CGSize winSize = CCDirector.sharedDirector().displaySize();
	
	public TiendaTricolinLayer(TiendaTricolin escena) 
	{
		super();
		...
		// Crear fondo
		fondo = CCSprite.sprite("fondoTienda.jpg");
