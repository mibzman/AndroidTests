...
public class CasitaTricolinLayer extends CCLayer {
	
	CCSprite fondo;
	CCSprite regresar;
	CasitaTricolin escena;
	CGSize winSize = CCDirector.sharedDirector().displaySize();
	
	public CasitaTricolinLayer(CasitaTricolin escena) 
	{
		super();
		...
		// Crear fondo
		fondo = CCSprite.sprite("fondoCasa.jpg");
