...
import com.example.pedometerfragment.PedometerDir.*;


public class StepService extends Service {
	private static final String TAG = "name.bagi.levente.pedometer.Pedometer.StepService";
  ...
  //  private SpeakingTimer mSpeakingTimer;
    ...
    private void showNotification() {
        ...
        pedometerIntent.setComponent(new ComponentName(this, MyActivity.class));
